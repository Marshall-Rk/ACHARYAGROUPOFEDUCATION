...
?>
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/vadim-sherbakov-d6ebY-faOO0-unsplash.jpg');">
        	...
        	<div class="col-md-8">
        		<div class="row mb-5">
		          <div class="col-md-4 text-center py-4">
		            ...
		            <p><span>Address:</span> Office no. 18 first floor Akansha Tower opposite Bappa Sitaram shopping mall Nallasopara(E)</p>
		          </div>
		          <div class="col-md-4 text-center border-height py-4">
		          	<div class="icon">
		          		<span class="icon-mobile-phone"></span>
		          	</div>
		            <p><span>Phone:</span> <a href="tel:8369830324">+91 8369830324</a><br><a href="tel:9175033190">+91 9175033190</a></p>
		          ...
		          <div class="col-md-4 text-center py-4">
		            ...
		            <p><span>Email:</span> <a href="mailto:acharyaeducation@gmail.com">acharyaeducation@gmail.com</a></p>
		          </div>
		        </div>
          </div>
        </div>
        <div class="row block-9 justify-content-center mb-2">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">If you got any questions <br>please do not hesitate to send us a message</h2>
            <form action="submit.php" method="post" class="bg-light p-5 contact-form">
              ...
              <input type="hidden" value="<?php echo rand(00000000,9999999999);?>" name="token" class="form-control" required>
              </div>
